...
<div class="controls flex items-center gap-2">
	...
	<div class="controls-icons ml-auto flex items-center gap-2">
		...
		<button type="button" class="btn-privacy" aria-label="About" onclick={onabout}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg></button>
		<BellButton />
	</div>
</div>
